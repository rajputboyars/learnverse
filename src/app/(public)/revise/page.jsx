  ...
  if (status !== 'authenticated') {
    return (
      <div className="mx-auto max-w-md px-4 py-20 text-center">
        <h1 className="text-2xl font-bold">🔁 {pick('Revision', 'Revision')}</h1>
        <p className="mt-2 text-slate-600">{pick('Login karke apne seekhe concepts spaced-repetition se revise karo.', 'Login to revise your learnt concepts with spaced repetition.')}</p>
