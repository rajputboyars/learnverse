// Jahia DXP curriculum — beginner -> intermediate -> advanced.
// Same shape as javascript.mjs, consumed by scripts/seed.mjs.
//
// Jahia moves faster than most CMS platforms, and the JavaScript modules engine
// in particular is still settling. The concepts here (JCR, workspaces, node
// types, view resolution, caching) are stable across versions; the exact import
// paths in the JS examples follow the 8.2 javascript-modules style and are worth
// checking against the version you actually run.
