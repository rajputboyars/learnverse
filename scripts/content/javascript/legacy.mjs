// The original JavaScript concepts, kept verbatim so their titles — and so
// their _ids and everyone's progress — survive the course upgrade.
// javascript.mjs regroups them into banded modules and adds lesson blocks.
...
/** Every original JavaScript concept, keyed by its (unchanged) title. */
